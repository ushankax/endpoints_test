...
def test_status_post_request_returns_correct_response_status_code(http_status):
    ...
    status_response = requests.post(f'https://httpbin.org/status/{http_status}')

    result_status_code = status_response.status_code

    assert result_status_code == http_status
...
def test_status_post_request_with_incorrect_code_returns_502(incorrect_http_status):
    ...
    status_response = requests.post(f'https://httpbin.org/status/{incorrect_http_status}')

    result_status_code = status_response.status_code

    assert result_status_code == HTTPStatus.BAD_GATEWAY
...
def test_status_post_request_with_incorrect_3_digit_code_returns_502():
    ...
    status_response = requests.post('https://httpbin.org/status/999')
...
def test_status_post_request_with_text_status_code_returns_400():
    ...
    status_response = requests.post('https://httpbin.org/status/text_code')
...
def test_status_post_request_with_empty_status_code_returns_404():
    ...
    status_response = requests.post('https://httpbin.org/status/')
...
def test_status_post_request_with_two_status_codes_returns_one_of_them_in_response():
    ...
    status_response = requests.post('https://httpbin.org/status/200,300')

    result_status_code = status_response.status_code

    assert result_status_code in (200, 300)
...
def test_status_post_request_with_two_codes_and_weights_returns_correct_response_status_code():
    ...
    status_response = requests.post('https://httpbin.org/status/200:1,300:2')
...
def test_status_post_request_with_only_code_and_weight_returns_400():
    ...
    status_response = requests.post('https://httpbin.org/status/200:1')
